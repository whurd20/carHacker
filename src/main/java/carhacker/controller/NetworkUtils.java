...
public class NetworkUtils {
    ...
    public static void generateURL() throws UnirestException {
        HttpResponse<String> response = Unirest.get("https://vindecoder.p.rapidapi.com/v1.1/decode_vin?vin=KNAFW4A39A5125881")
